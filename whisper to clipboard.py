...
parser.add_argument("--device", default="cuda", help="device to use for PyTorch inference")
...
parser.add_argument("--amplification", type=int, default=1, help="inference audio integer amplification/boost")
...
amplification: str = args.pop("amplification")
